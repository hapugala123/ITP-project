...
@section('content')
    ...
    {!! Form::model($purchase, ['method' => 'PUT', 'route' => ['admin.purchases.update', $purchase->id], 'files' => true,]) !!}
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            ...
            <div class="row">
                <div class="col-xs-12 form-group">
                    @if ($purchase->photo)
                        <a href="{{ asset(env('UPLOAD_PATH').'/'.$purchase->photo) }}" target="_blank"><img src="{{ asset(env('UPLOAD_PATH').'/thumb/'.$purchase->photo) }}"></a>
                    @endif
